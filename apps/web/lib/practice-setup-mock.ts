...
const configs: Record<PracticePartId, PracticeSetupConfig> = {
  ...
  part2: {
    partId: "part2",
    examBadgeLabel: "Phòng thi mô phỏng",
    title: "Part 2 — trước khi bạn nói",
    introDescription: "Bốn điều diễn ra trong 5 phút tới. Đọc nhanh rồi vào phòng.",
    infoItems: [
      {
        icon: "headphones",
        title: "Áp lực như thật",
        description: "Giám khảo AI đưa chủ đề và bạn nói liền một mạch, không có thời gian tra từ.",
      },
      {
        icon: "timer",
        title: "Tối đa 120 giây",
        description: "Hết giờ là tự kết thúc — tập phản xạ, không tập đọc.",
      },
      {
        icon: "chart",
        title: "Điểm sát thi thật",
        description: "Chấm 4 tiêu chí ngay khi bạn nói xong.",
      },
      {
        icon: "pen",
        title: "Sửa lỗi theo câu",
  ...
  full: {
    partId: "full",
    examBadgeLabel: "Phòng thi mô phỏng",
    title: "Thi thử đầy đủ — trước khi bạn nói",
    introDescription: "Bốn điều diễn ra trong 5 phút tới. Đọc nhanh rồi vào phòng.",
    infoItems: [
      {
        icon: "headphones",
        title: "Áp lực như thật",
        description: "Giám khảo AI dẫn bạn qua cả 3 part liên tiếp, không có thời gian tra từ.",
      },
      {
        icon: "timer",
        title: "Tối đa 40s, 120s, 50s cho Part 1, Part 2 và Part 3",
        description: "Hết giờ là tự chuyển câu — tập phản xạ, không tập đọc.",
      },
      {
        icon: "chart",
