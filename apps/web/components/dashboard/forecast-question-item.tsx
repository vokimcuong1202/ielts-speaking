...
export function ForecastQuestionItem({ question }: { question: ForecastQuestion }) {
  return (
    <button
      type="button"
      className="flex cursor-pointer flex-col gap-2 rounded-xl border border-border p-4 text-left transition-colors hover:border-brand-300 hover:bg-brand-50/40"
    >
