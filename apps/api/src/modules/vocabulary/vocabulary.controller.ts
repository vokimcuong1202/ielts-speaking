...
import { SRS_STATES, SaveCustomVocabDto, SaveVocabBulkDto, SaveVocabDto, SubmitReviewDto, VOCAB_KINDS } from "./dto/vocabulary.dto";
...
export class VocabularyController {
  ...
  @Post("notebook/custom")
  saveCustom(@CurrentUser() user: { userId: string }, @Body() dto: SaveCustomVocabDto) {
    return this.vocabularyService.saveCustomItem(user.userId, dto);
  }
